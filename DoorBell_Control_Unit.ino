...
while (digitalRead(Bellbutton) == HIGH); {          // Monitors if the bellbutton is pressed
...
if (SwitchState == 1) {                              // Runs if the switch gives a positive signal
...
else {                                               // Runs if the switch gives a negative / no signal
